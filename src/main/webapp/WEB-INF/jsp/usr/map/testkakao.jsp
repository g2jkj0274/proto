...
<c:set var="pageTitle" value="테스트 지도 " />
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=f2e8b8dfe2eeda94b06ca3878c8af6cf&libraries=services"></script>
<script>
